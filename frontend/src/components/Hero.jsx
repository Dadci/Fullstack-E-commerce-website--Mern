        ...
        <div className="bg-white">
            <div className="flex flex-col border-b border-gray-200 lg:border-0">
                <nav aria-label="Offers" className="order-last lg:order-first">
                    <div className="mx-auto max-w-full lg:px">
                        <ul
                            role="list"
                            className="grid grid-cols-1 divide-y divide-gray-200 lg:grid-cols-3 lg:divide-x lg:divide-y-0"
                        >
                            {offers.map((offer) => (
                                <li key={offer.name} className="flex flex-col items-center justify-center">
                                    <a
                                        href={offer.href}
                ...
                <div className="relative">
                    ...
                    <div className="relative bg-gray-100 lg:bg-transparent">
                        <div className="mx-auto max-w-8xl px-4 sm:px-6 lg:grid lg:grid-cols-2 lg:px-8">
                            <div className="mx-auto w-full max-w-full py-24 lg:py-36 flex items-center justify-center">
                                <div className="lg:pr-24 text-left">
                                    ...
                                    <p className="mt-4 text-xl font-light text-gray-600">
                                        Discover cutting-edge tech that transforms your everyday life. <br />From smart home devices to the latest gadgets, <br />
                                        find innovation at your fingertips.
                                    </p>
                                    <div className="mt-8">
                                        <a
                                            href="#"
                                            className="inline-block rounded-lg border border-transparent bg-blue-600 px-10 py-2.5 font-medium text-white hover:bg-blue-800"
                                        >
                                            Explore Gadgets
                                        </a>
                                    </div>
